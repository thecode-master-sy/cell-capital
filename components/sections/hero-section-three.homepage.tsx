    ...
    <div className="bg-background">
      ...
      <div className="flex relative h-[600px] z-1 overflow-hidden">
        <div className="flex  flex-col absolute w-full top-0 z-[1]">
          <Button className="bg-primary   mx-auto mt-2 border border-black   text-primary rounded-sm cursor-pointer items-center h-auto px-7 py-2 text-paragraph font-semibold">
